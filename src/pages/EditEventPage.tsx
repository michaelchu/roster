...
export function EditEventPage() {
  ...
  const deleteEvent = async () => {
    ...
    if (!confirm('Are you sure you want to delete this event? All participants and data will be permanently removed.')) {
      return
    }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500">This event doesn't exist or you don't have permission to edit it.</p>
        </div>
      </div>
    )
  }
